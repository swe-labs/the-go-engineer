# Lesson: What job-ready means

## Mission

Define job readiness as demonstrated ability across implementation, testing, debugging, communication, and operations.
...
Job readiness is not a feeling. It is a portfolio of repeatable evidence.
...
Hiring signals come from working projects, clear READMEs, tests, commits, diagrams, tradeoff explanations, and debugging maturity.
...
```bash
go run ./curriculum/modules/00-orientation/lessons/08-what-job-ready-means
...
Audit a sample portfolio against the readiness dimensions and identify the weakest signal.
...
```text
core-00-09 — ../09-how-to-use-the-roadmap/README.md
```
