# Lesson: How to use the roadmap

## Mission

Learn how to follow module prerequisites, pacing, and proof requirements without getting lost.
...
The roadmap is a dependency graph, not a playlist. Each module unlocks later modules by giving you tools they rely on.
...
Metadata stores prerequisites, entry items, terminal items, concepts, assessments, and portfolio outputs so the path can be validated.
...
```bash
go run ./curriculum/modules/00-orientation/lessons/09-how-to-use-the-roadmap
...
Trace your path from Module 00 through Module 10 and explain why each major step appears in that order.
...
```text
core-00-10 — ../10-how-to-build-a-portfolio-from-this-curriculum/README.md
```
