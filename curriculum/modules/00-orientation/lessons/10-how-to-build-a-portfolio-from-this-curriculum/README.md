# Lesson: How to build a portfolio from this curriculum

## Mission

Learn how to turn curriculum projects into professional evidence without overselling or underexplaining your work.
...
A portfolio is a case file. It shows the problem, your design, your proof, your tradeoffs, and what you learned.
...
Strong portfolio artifacts include a README, architecture diagram, test instructions, deployment notes, screenshots or logs, and clear commit history.
...
```bash
go run ./curriculum/modules/00-orientation/lessons/10-how-to-build-a-portfolio-from-this-curriculum
...
Create a portfolio plan with three future projects, the proof each should show, and the story each project should tell.
...
```text
module-01 — ../../../01-computers-terminal-git-web/README.md
```
