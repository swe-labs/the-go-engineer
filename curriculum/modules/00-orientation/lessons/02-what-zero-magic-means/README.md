# Lesson: What zero magic means

## Mission

Understand the curriculum promise that no required idea should appear without explanation, proof, and context.
...
Zero magic is like opening a machine and labeling every gear before asking you to repair it.
...
In code, magic usually appears as hidden state, implicit behavior, unexplained defaults, or commands whose outputs are not interpreted.
...
```bash
go run ./curriculum/modules/00-orientation/lessons/02-what-zero-magic-means
...
Take one compact expression or command and expand every assumption it hides.
...
```text
core-00-03 — ../../labs/03-how-lessons-exercises-projects-and-checkpoints-work/README.md
```
