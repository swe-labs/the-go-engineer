# Lesson: How starter folders work

## Mission

Understand how to use `_starter/` and `_solution/` folders without turning practice into copying.
...
The starter is a gym lane with missing reps. The solution is a coach's reference, not your first stop.
...
Starter folders usually contain incomplete but runnable scaffolds. Solution folders contain one complete implementation that passes the intended tests.
...
```bash
go run ./curriculum/modules/00-orientation/lessons/05-how-starter-folders-work
...
Compare a starter and solution folder. Identify what was intentionally left for the learner.
...
```text
core-00-06 — ../06-how-assessments-work/README.md
```
