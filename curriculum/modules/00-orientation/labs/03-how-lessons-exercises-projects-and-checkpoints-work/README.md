# Lab: How lessons, exercises, projects, and checkpoints work

## Mission

Practice the full learning loop: read, run, try, verify, reflect, and move on.
...
A lesson teaches the move, a lab lets you rehearse it, a project asks you to perform it, and a checkpoint verifies the performance.
...
The repository separates content types so validators and learners can tell whether a folder is teaching, practice, proof, or assessment.
...
```bash
go run ./curriculum/modules/00-orientation/labs/03-how-lessons-exercises-projects-and-checkpoints-work
...
Complete the lab cycle and write down which artifact proves completion.
...
```text
core-00-04 — ../../lessons/04-how-to-run-code-in-this-repository/README.md
```
