...
```bash
go run ./06-backend-db/01-web-and-database/02-database-migrations/1-embedded-migrations
```
...
> [!TIP]
> You have mastered the components of a backend service. Now, it's time to see how they all fit together in a real-world application. In [Lesson 1: Web Masterclass](../../06-web-masterclass/README.md), you will explore a larger codebase that integrates everything you've learned.
