...
Next: `HS.3` -> `06-backend-db/01-web-and-database/http-servers/3-middleware-pattern`

Open `06-backend-db/01-web-and-database/http-servers/3-middleware-pattern/README.md` to continue.
