...
```bash
go run ./06-backend-db/01-web-and-database/05-http-servers/09-health-and-readiness-probes
```
...
Next: `HS.10` -> [`06-backend-db/01-web-and-database/05-http-servers/10-rest-api-exercise`](../10-rest-api-exercise/README.md)
