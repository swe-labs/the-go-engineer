...
```bash
go run ./06-backend-db/01-web-and-database/05-http-servers/06-error-handling-middleware
```
...
> [!TIP]
> Your server is now stable and handles errors like a pro. But in the real world, requests can hang forever. In [Lesson 7: Server Timeouts](../07-server-timeouts/README.md), you will learn how to protect your server's resources from slow clients and hanging dependencies.

## Next Step

Next: `HS.7` -> [`06-backend-db/01-web-and-database/05-http-servers/07-server-timeouts`](../07-server-timeouts/README.md)
