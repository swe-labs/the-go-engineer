...
```bash
go run ./06-backend-db/01-web-and-database/05-http-servers/01-net-http-basics
```
...
> [!TIP]
> You've built a basic server, but what happens when you have dozens of complex routes with variables in the path? In [Lesson 2: Routing Patterns](../02-routing-patterns/README.md), we will dive into advanced routing techniques and RESTful design.

## Next Step

Next: `HS.2` -> [`06-backend-db/01-web-and-database/05-http-servers/02-routing-patterns`](../02-routing-patterns/README.md)
