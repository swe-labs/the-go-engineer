...
```bash
go run ./06-backend-db/01-web-and-database/05-http-servers/02-routing-patterns
```
...
> [!TIP]
> Now that you can route requests to the right handlers, how do you handle cross-cutting concerns like logging every request or checking for authentication? In [Lesson 3: Middleware Pattern](../03-middleware-pattern/README.md), you will learn how to wrap your handlers with reusable logic.

## Next Step

Next: `HS.3` -> [`06-backend-db/01-web-and-database/05-http-servers/03-middleware-pattern`](../03-middleware-pattern/README.md)
