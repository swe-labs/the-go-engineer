# Legacy Reference: Web Development Masterclass
...
go run ./06-backend-db/01-web-and-database/06-web-masterclass/1-routing
go run ./06-backend-db/01-web-and-database/06-web-masterclass/4-middleware
go run ./06-backend-db/01-web-and-database/06-web-masterclass/8-posts-crud

# Run the full capstone app
go run ./06-backend-db/01-web-and-database/06-web-masterclass/11-websockets
