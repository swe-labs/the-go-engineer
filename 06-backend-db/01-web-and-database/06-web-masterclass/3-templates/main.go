...
//
// RUN:
//   go run ./06-backend-db/01-web-and-database/06-web-masterclass/3-templates
//
// KEY TAKEAWAY:
...
func main() {
	...
	fmt.Println("\n---------------------------------------------------")
	fmt.Println("NEXT UP: MC.4 -> 06-backend-db/01-web-and-database/06-web-masterclass/4-middleware")
