...
```bash
go run ./06-backend-db/01-web-and-database/01-apis/07-grpc-interceptors
```
...
> [!TIP]
> You've mastered both REST and gRPC. Which one should you use for your next project? In [Lesson 8: REST vs gRPC - The Trade-off](../08-rest-vs-grpc/README.md), we will compare these two giants head-to-head.

## Next Step

Next: `API.8` -> [`06-backend-db/01-web-and-database/01-apis/08-rest-vs-grpc`](../08-rest-vs-grpc/README.md)
