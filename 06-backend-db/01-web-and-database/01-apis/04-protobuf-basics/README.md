...
```bash
go run ./06-backend-db/01-web-and-database/01-apis/04-protobuf-basics
```
...
> [!TIP]
> You have the data format. Now you need a transport protocol to move that data between servers. In [Lesson 5: gRPC Fundamentals](../05-grpc-fundamentals/README.md), you will learn how to use Protobuf to build high-performance Remote Procedure Calls.

## Next Step

Next: `API.5` -> [`06-backend-db/01-web-and-database/01-apis/05-grpc-fundamentals`](../05-grpc-fundamentals/README.md)
