...
> [!TIP]
> Your API is well-designed, but what happens when you need to change the data structure without breaking existing mobile apps? In [Lesson 2: API Versioning Strategies](../02-api-versioning-strategies/README.md), you will learn how to evolve your API safely.

## Next Step

Next: `API.2` -> [`06-backend-db/01-web-and-database/01-apis/02-api-versioning-strategies`](../02-api-versioning-strategies/README.md)
