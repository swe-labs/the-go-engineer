...
```bash
go run ./06-backend-db/01-web-and-database/01-apis/08-rest-vs-grpc
```
...
> [!TIP]
> You have the knowledge. Now it's time for the proof. In [Lesson 9: gRPC Service Exercise](../09-grpc-service-exercise/README.md), you will build a complete gRPC service that handles both Unary and Streaming calls.

## Next Step

Next: `API.9` -> [`06-backend-db/01-web-and-database/01-apis/09-grpc-service-exercise`](../09-grpc-service-exercise/README.md)
