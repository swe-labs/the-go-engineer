...
> [!TIP]
> You have mastered the "Web" side of Backend Engineering. Now, it's time to learn about the "Database" side. In [Section 06: Databases / Lesson 1: Connecting to SQLite](../../03-databases/01-connecting-to-db/README.md), you will begin your journey into persistent data storage.

## Next Step

Next: `DB.1` -> [`06-backend-db/01-web-and-database/03-databases/01-connecting-to-db`](../../03-databases/01-connecting-to-db/README.md)
