...
```bash
go run ./06-backend-db/01-web-and-database/01-apis/06-grpc-streaming
```
...
> [!TIP]
> Now that you can send data in every possible way, how do you handle security, logging, and metrics for all these calls? In [Lesson 7: gRPC Interceptors](../07-grpc-interceptors/README.md), you will learn how to wrap gRPC calls with middleware logic.

## Next Step

Next: `API.7` -> [`06-backend-db/01-web-and-database/01-apis/07-grpc-interceptors`](../07-grpc-interceptors/README.md)
