...
> [!TIP]
> You've learned how to insert data. Now let's learn how to retrieve it. In [Lesson 3: SELECTing Data](../03-select/README.md), you will learn how to query rows and scan them into Go structs.

## Next Step

Next: `DB.3` -> [`06-backend-db/01-web-and-database/03-databases/03-select`](../03-select/README.md)
