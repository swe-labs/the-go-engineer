...
```bash
go run ./06-backend-db/01-web-and-database/03-databases/03-select
```
...
> [!TIP]
> You're reading and writing data. But repeating the same SQL string over and over is inefficient for the database. In [Lesson 4: Prepared Statements](../04-prepare/README.md), you will learn how to "pre-compile" your SQL to make it faster and safer.

## Next Step

Next: `DB.4` -> [`06-backend-db/01-web-and-database/03-databases/04-prepare`](../04-prepare/README.md)
