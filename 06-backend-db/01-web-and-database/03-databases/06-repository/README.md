...
```bash
go run ./06-backend-db/01-web-and-database/03-databases/06-repository
```
...
> [!TIP]
> Your code is clean and organized. But as your data grows, you might accidentally write inefficient queries that perform thousands of small calls to the database. In [Lesson 7: N+1 Query Detection](../07-n-plus-one-query-detection/README.md), you will learn how to identify and fix one of the most common performance killers in backend engineering.

## Next Step

Next: `DB.7` -> [`06-backend-db/01-web-and-database/03-databases/07-n-plus-one-query-detection`](../07-n-plus-one-query-detection/README.md)
