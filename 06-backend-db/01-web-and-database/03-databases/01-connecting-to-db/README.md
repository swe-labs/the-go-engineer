...
```bash
go run ./06-backend-db/01-web-and-database/03-databases/01-connecting-to-db
```
...
> [!TIP]
> You have a connection. Now let's put some data in it. In [Lesson 2: Executing Queries (INSERT)](../02-query/README.md), you will learn how to safely insert data using prepared statements to prevent SQL injection.

## Next Step

Next: `DB.2` -> [`06-backend-db/01-web-and-database/03-databases/02-query`](../02-query/README.md)
