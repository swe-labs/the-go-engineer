...
//
// RUN:
//   go run ./06-backend-db/01-web-and-database/04-http-client/1-get-posts
//
// KEY TAKEAWAY:
...
func main() {
	...
	fmt.Println("\n---------------------------------------------------")
	fmt.Println("NEXT UP: HC.2 -> 06-backend-db/01-web-and-database/04-http-client/2-refactor-for-testability")
