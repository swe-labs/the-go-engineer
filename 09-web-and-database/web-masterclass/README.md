...
go run ./09-web-and-database/web-masterclass/1-routing
go run ./09-web-and-database/web-masterclass/4-middleware
go run ./09-web-and-database/web-masterclass/8-posts-crud

# Run the full capstone app
go run ./09-web-and-database/web-masterclass/11-websockets
