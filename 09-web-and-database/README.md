...
This live v2 slice keeps the current `09-web-and-database` filesystem layout intact while
...
- `DB.1` through `DB.6` stay in `09-web-and-database/databases/*`
...
[Section 11: Concurrency](../10-concurrency) and
