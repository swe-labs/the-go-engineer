...
```bash
go run ./09-web-and-database/databases/6-repository
```

Run the tests:

```bash
go test ./09-web-and-database/databases/6-repository
```

Run the starter:

```bash
go run ./09-web-and-database/databases/6-repository/_starter
```
...
After you complete this milestone, continue to [Section 11: Concurrency](../../10-concurrency) or
