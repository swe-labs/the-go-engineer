...
go run ./10-production/02-graceful-shutdown/03-capstone
```
...
- Use `go run ./10-production/02-graceful-shutdown/03-capstone`.
- Starter path: `10-production/02-graceful-shutdown/03-capstone/_starter`.
...
Next: `CFG.1` -> [`10-production/04-configuration/01-environment-variables`](../../04-configuration/01-environment-variables/README.md)
