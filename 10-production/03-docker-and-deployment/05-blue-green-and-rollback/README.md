...
go run ./10-production/03-docker-and-deployment/05-blue-green-and-rollback
```
...
Next: `DEPLOY.3` -> [`10-production/03-docker-and-deployment/06-dockerised-service`](../06-dockerised-service/README.md)
