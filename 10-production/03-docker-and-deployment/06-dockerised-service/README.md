...
cd 10-production/03-docker-and-deployment/06-dockerised-service/_starter
...
- Use `go run ./10-production/03-docker-and-deployment/06-dockerised-service`.
- Starter path: `10-production/03-docker-and-deployment/06-dockerised-service/_starter`.
...
Next: `CG.1` -> [`10-production/06-code-generation/01-go-generate`](../../06-code-generation/01-go-generate/README.md)
