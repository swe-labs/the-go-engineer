...
//
// RUN:
//   go run ./10-production/03-docker-and-deployment/04-cicd-pipelines
//
// KEY TAKEAWAY:
...
func main() {
	...
	fmt.Println()
	fmt.Println("---------------------------------------------------")
	fmt.Println("NEXT UP: DEPLOY.2 -> 10-production/03-docker-and-deployment/05-blue-green-and-rollback")
