...
# docker build -t my-slim-app ./10-production/03-docker-and-deployment/02-multi-stage-builds
...
Next: `DOCKER.3` -> [`10-production/03-docker-and-deployment/03-docker-compose`](../03-docker-compose/README.md)
