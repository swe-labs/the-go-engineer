...
# docker build -t my-go-app ./10-production/03-docker-and-deployment/01-docker-basics
...
Next: `DOCKER.2` -> [`10-production/03-docker-and-deployment/02-multi-stage-builds`](../02-multi-stage-builds/README.md)
