...
go run ./10-production/04-configuration/04-twelve-factor-principles
```
...
Next: `CFG.5` -> [`10-production/04-configuration/05-config-validation-on-boot`](../05-config-validation-on-boot/README.md)
