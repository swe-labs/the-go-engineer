...
# Windows (PowerShell):
# $env:APP_PORT=9000; go run ./10-production/04-configuration/01-environment-variables
# Linux/macOS:
# APP_PORT=9000 go run ./10-production/04-configuration/01-environment-variables
```
...
Next: `CFG.2` -> [`10-production/04-configuration/02-configuration-files`](../02-configuration-files/README.md)
