...
go run ./10-production/04-configuration/03-flag-parsing

# Run with a custom flag
go run ./10-production/04-configuration/03-flag-parsing -port=7000
```
...
Next: `CFG.4` -> [`10-production/04-configuration/04-twelve-factor-principles`](../04-twelve-factor-principles/README.md)
