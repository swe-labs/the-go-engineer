...
```bash
# Start the service
go run ./10-production/05-observability/02-prometheus-integration
...
Next: `OPS.3` -> [`10-production/05-observability/03-distributed-tracing-basics`](../03-distributed-tracing-basics/README.md)
