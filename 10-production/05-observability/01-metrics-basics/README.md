...
go run ./10-production/05-observability/01-metrics-basics
```
...
Next: `OPS.2` -> [`10-production/05-observability/02-prometheus-integration`](../02-prometheus-integration/README.md)
