...
go run ./10-production/05-observability/05-alerting-mindset
```
...
Next: `DOCKER.1` -> [`10-production/03-docker-and-deployment/01-docker-basics`](../../03-docker-and-deployment/01-docker-basics/README.md)
