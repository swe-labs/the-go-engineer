...
go run ./10-production/01-structured-logging/02-context-logger
```
...
Next: `SL.3` -> [`10-production/01-structured-logging/03-custom-handler`](../03-custom-handler/README.md)
