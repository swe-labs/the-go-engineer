...
go run ./10-production/01-structured-logging/03-custom-handler
```
...
Next: `SL.4` -> [`10-production/01-structured-logging/04-zerolog-comparison`](../04-zerolog-comparison/README.md)
