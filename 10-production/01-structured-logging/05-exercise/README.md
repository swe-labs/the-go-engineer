...
go test -v ./10-production/01-structured-logging/05-exercise
```
...
- Use `go test -v ./10-production/01-structured-logging/05-exercise`.
- Starter path: `10-production/01-structured-logging/05-exercise/_starter`.
...
Next: `GS.1` -> [`10-production/02-graceful-shutdown/01-signal-context`](../../02-graceful-shutdown/01-signal-context/README.md)
