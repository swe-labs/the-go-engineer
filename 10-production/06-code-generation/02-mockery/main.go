...
//
// RUN:
//   go run ./10-production/06-code-generation/02-mockery
// KEY TAKEAWAY:
...
import (
	...
	"github.com/swe-labs/the-go-engineer/10-production/06-code-generation/02-mockery/internal/storage"
)
...
func main() {
	...
	fmt.Println("  go generate ./10-production/06-code-generation/02-mockery/...")
	...
	fmt.Println("\n---------------------------------------------------")
	fmt.Println("NEXT UP: CG.3 -> 10-production/06-code-generation/03-sqlc")
