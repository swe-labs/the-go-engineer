...
> [!NOTE]
> This simple rule - capitalization - is the foundation for package design in Go. You will see how this enables clear module boundaries in [MP.1 Module Basics](../../05-packages-io/01-modules-and-packages/01-module-basics/README.md).
...
```bash
go run ./01-getting-started/03-how-go-works
```
...
Next: `GT.4` -> [`01-getting-started/04-dev-environment`](../04-dev-environment/README.md)
