...
```bash
go run ./01-getting-started/06-reading-compiler-errors
```
...
> [!NOTE]
> These errors are generated during the "Type Checking" and "Parsing" stages of the compiler pipeline you learned in [HC.2 Code to Execution](../../00-how-computers-work/02-code-to-execution/README.md).

## Next Step

Next: `LB.1` -> [`02-language-basics/01-variables`](../../02-language-basics/01-variables/README.md)
