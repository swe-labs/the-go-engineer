...
//  7. [ ] Make `go test ./06-strings-and-text/6-config-parser` pass
//
// HINTS:
...
//
// RUN: go run ./06-strings-and-text/6-config-parser/_starter
// TEST: go test ./06-strings-and-text/6-config-parser
