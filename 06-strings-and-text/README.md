...
- `ST.6` stays at `06-strings-and-text/6-config-parser`, now treated as the section milestone
  surface
...
From there, move to [05 Packages & IO](../docs/stages/05-packages-io.md).
The first source section in that next stage is
[Section 08: Modules and Packages](../07-modules-and-packages).
