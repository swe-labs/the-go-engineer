...
```bash
go run ./03-functions-errors/01-functions-basics
```
...
> [!TIP]
> This lesson taught you how to move code into a named function, but these functions didn't take any data or return any answers. In [FE.2 Parameters and Returns](../02-parameters-and-returns/README.md), you will learn how to pass data across the function boundary.
...
Next: `FE.2` -> [`03-functions-errors/02-parameters-and-returns`](../02-parameters-and-returns/README.md)
