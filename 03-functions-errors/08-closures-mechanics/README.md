...
```bash
go run ./03-functions-errors/08-closures-mechanics
```
...
> [!TIP]
> You have now learned the most advanced mechanics of Go functions. It's time to apply them in a real-world scenario. In [FE.7 Order Summary](../09-order-summary/README.md), you will use closures to create dynamic, configurable pricing rules.
...
Next: `FE.7` -> [`03-functions-errors/09-order-summary`](../09-order-summary/README.md)
