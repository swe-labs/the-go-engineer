...
// RUN: go run ./10-concurrency/time-and-scheduling/7-reminder
package main
...
//
// USAGE: go run ./10-concurrency/time-and-scheduling/7-reminder <seconds> <message>
// EXAMPLE: go run ./10-concurrency/time-and-scheduling/7-reminder 5 "Take a break!"
// ============================================================================
