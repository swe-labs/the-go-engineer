...
```bash
go run ./04-types-design/02-methods
```
...
> [!NOTE]
> Methods are the mechanism through which Go satisfies [TI.3 Interfaces](../03-interfaces/README.md).
...
Next: `TI.7` -> [`04-types-design/07-receiver-sets`](../07-receiver-sets/README.md)
