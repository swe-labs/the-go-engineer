...
//
// RUN:
//   go run ./04-types-design/03-interfaces
//
// KEY TAKEAWAY:
...
func main() {
	...
	fmt.Println()
	fmt.Println("---------------------------------------------------")
	fmt.Println("NEXT UP: TI.4 -> 04-types-design/04-interface-embedding")
	fmt.Println("Run    : go run ./04-types-design/04-interface-embedding")
