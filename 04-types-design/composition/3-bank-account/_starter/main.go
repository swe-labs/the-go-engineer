...
//  9. [ ] Make `go test ./04-types-design/composition/3-bank-account` pass
//
// HINTS:
...
//
// RUN: go run ./04-types-design/composition/3-bank-account/_starter
// TEST: go test ./04-types-design/composition/3-bank-account
