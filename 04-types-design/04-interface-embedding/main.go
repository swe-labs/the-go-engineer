...
//
// RUN:
//   go run ./04-types-design/04-interface-embedding
//
// KEY TAKEAWAY:
...
func main() {
	...
	fmt.Println()
	fmt.Println("---------------------------------------------------")
	fmt.Println("NEXT UP: TI.6 -> 04-types-design/06-type-switch")
	fmt.Println("Run    : go run ./04-types-design/06-type-switch")
