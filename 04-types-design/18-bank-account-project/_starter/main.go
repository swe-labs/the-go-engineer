...
//  9. [ ] Make `go test ./04-types-design/18-bank-account-project` pass
//
// HINTS:
...
//
// RUN: go run ./04-types-design/18-bank-account-project/_starter
// TEST: go test ./04-types-design/18-bank-account-project
