...
func main() {
	...
	fmt.Println()
	fmt.Println("---------------------------------------------------")
	fmt.Println("NEXT UP: CF.7 -> 02-language-basics/03-control-flow/07-pricing-checkout")
	fmt.Println("Run    : go run ./02-language-basics/03-control-flow/07-pricing-checkout")
