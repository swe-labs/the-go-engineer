...
func main() {
	...
	fmt.Println()
	fmt.Println("---------------------------------------------------")
	fmt.Println("NEXT UP: CF.6 -> 02-language-basics/03-control-flow/06-defer-use-cases")
	fmt.Println("Run    : go run ./02-language-basics/03-control-flow/06-defer-use-cases")
