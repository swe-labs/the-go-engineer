...
func main() {
	...
	fmt.Println()
	fmt.Println("---------------------------------------------------")
	fmt.Println("NEXT UP: DS.6 -> 02-language-basics/04-data-structures/06-contact-manager")
	fmt.Println("Run    : go run ./02-language-basics/04-data-structures/06-contact-manager")
