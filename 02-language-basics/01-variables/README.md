...
> [!NOTE]
> For a deeper look at how Go manages memory for variables, revisit [HC.3 Memory Basics](../../00-how-computers-work/03-memory-basics/README.md).

## Run Instructions

```bash
go run ./02-language-basics/01-variables
```
...
## Try It
> The compiler strictly enforces code quality. If you declare a local variable but never use it, the compiler will refuse to build the program. This was introduced in [GT.6 Reading Compiler Errors](../../01-getting-started/06-reading-compiler-errors/README.md).
...
Next: `LB.2` -> [`02-language-basics/02-constants`](../02-constants/README.md)
