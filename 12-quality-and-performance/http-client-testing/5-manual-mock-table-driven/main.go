...
// RUN: go run ./12-quality-and-performance/http-client-testing/5-manual-mock-table-driven
package main
...
//
// RUN: go test -v ./12-quality-and-performance/http-client-testing/5-manual-mock-table-driven
// ============================================================================
