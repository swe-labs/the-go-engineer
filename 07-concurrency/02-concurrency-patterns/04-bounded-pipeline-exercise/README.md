...
```bash
go run ./07-concurrency/02-concurrency-patterns/04-bounded-pipeline-exercise
```
...
Next: `CP.5` -> [`07-concurrency/02-concurrency-patterns/05-url-checker-exercise`](../05-url-checker-exercise/README.md)
