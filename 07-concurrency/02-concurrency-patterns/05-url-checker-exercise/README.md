...
```bash
go run ./07-concurrency/02-concurrency-patterns/05-url-checker-exercise
```
...
Next: `TE.1` -> [`08-quality-test/01-quality-and-performance/02-testing/01-unit-testing`](../../../08-quality-test/01-quality-and-performance/02-testing/01-unit-testing/README.md)
