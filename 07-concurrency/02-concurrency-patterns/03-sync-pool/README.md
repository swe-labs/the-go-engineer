...
```bash
go run ./07-concurrency/02-concurrency-patterns/03-sync-pool
```
...
Next: `CP.4` -> [`07-concurrency/02-concurrency-patterns/04-bounded-pipeline-exercise`](../04-bounded-pipeline-exercise/README.md)
