...
```bash
go run ./07-concurrency/02-concurrency-patterns/01-errgroup
```
...
Next: `CP.2` -> [`07-concurrency/02-concurrency-patterns/02-errgroup-context`](../02-errgroup-context/README.md)
