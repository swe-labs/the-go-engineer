...
```bash
go run ./07-concurrency/01-concurrency/04-time-and-scheduling/03-timer-and-ticker
```
...
> [TM.7](../07-reminder/README.md) which exercises the timer and ticker
> concepts from this lesson.

## Next Step

Next: `TM.7` -> [`07-concurrency/01-concurrency/04-time-and-scheduling/07-reminder`](../07-reminder/README.md)
