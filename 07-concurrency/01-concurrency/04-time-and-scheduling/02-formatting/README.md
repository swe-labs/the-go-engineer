...
```bash
go run ./07-concurrency/01-concurrency/04-time-and-scheduling/02-formatting
```
...
Next: `TM.3` -> [`07-concurrency/01-concurrency/04-time-and-scheduling/03-timer-and-ticker`](../03-timer-and-ticker/README.md)
