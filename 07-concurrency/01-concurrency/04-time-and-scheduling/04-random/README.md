...
```bash
go run ./07-concurrency/01-concurrency/04-time-and-scheduling/04-random
```
...
We've learned to generate random events. Now let's learn how to schedule them precisely in the future. Continue to [TM.5 Task Scheduling](../05-schedule/README.md).
