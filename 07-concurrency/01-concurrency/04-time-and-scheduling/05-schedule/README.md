...
```bash
go run ./07-concurrency/01-concurrency/04-time-and-scheduling/05-schedule
```
...
We've mastered scheduling. Now let's learn how to handle the "Where" of time: Timezones and Locations. Continue to [TM.6 Timezones](../06-timezone/README.md).
