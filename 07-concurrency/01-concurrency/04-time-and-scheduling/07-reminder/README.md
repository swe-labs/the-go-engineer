...
```bash
go run ./07-concurrency/01-concurrency/04-time-and-scheduling/07-reminder 5 "Take a break!"
```
...
Next: `CP.1` -> [`07-concurrency/02-concurrency-patterns/01-errgroup`](../../../02-concurrency-patterns/01-errgroup/README.md)
