...
```bash
go run ./07-concurrency/01-concurrency/04-time-and-scheduling/06-timezone
```
...
We've mastered the theory. Now let's build something practical. Continue to [TM.7 Console Reminder](../07-reminder/README.md).
