...
```bash
go run ./07-concurrency/01-concurrency/02-goroutines/06-project-1
```
...
Next: `GC.7` -> [`07-concurrency/01-concurrency/02-goroutines/07-downloader`](../07-downloader/README.md)
