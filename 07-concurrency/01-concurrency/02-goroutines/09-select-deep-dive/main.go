...
// ============================================================================
//
// RUN: go run ./07-concurrency/01-concurrency/02-goroutines/09-select-deep-dive
// ============================================================================
...
func main() {
	...
	fmt.Println("\n---------------------------------------------------")
	fmt.Println("NEXT UP: GC.10 -> 07-concurrency/01-concurrency/02-goroutines/10-sync-primitives")
