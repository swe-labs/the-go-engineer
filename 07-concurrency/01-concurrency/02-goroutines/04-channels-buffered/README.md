...
```bash
go run ./07-concurrency/01-concurrency/02-goroutines/04-channels-buffered
```
...
Next: `GC.5` -> [`07-concurrency/01-concurrency/02-goroutines/05-channels-closing`](../05-channels-closing/README.md)
