...
// ============================================================================
//
// RUN: go run ./07-concurrency/01-concurrency/02-goroutines/10-sync-primitives
// ============================================================================
...
func main() {
	...
	fmt.Println("\n---------------------------------------------------")
	fmt.Println("NEXT UP: CT.1 -> 07-concurrency/01-concurrency/01-context/01-background")
