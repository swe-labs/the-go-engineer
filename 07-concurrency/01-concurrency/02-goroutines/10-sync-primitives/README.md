# GC.10 Sync Primitives: Once and Map
...
```bash
go run ./07-concurrency/01-concurrency/02-goroutines/10-sync-primitives
```
...
We've finished the Goroutines track! Now let's explore the specialized synchronization tools used for more complex coordination. Continue to [SY.1 Mutex](../../03-sync-primitives/01-mutex-and-rwmutex/README.md).
