...
//
// RUN:
//   go run ./07-concurrency/01-concurrency/02-goroutines/01-goroutine
//
// KEY TAKEAWAY:
...
func main() {
	...
	fmt.Println("  - Next: go run ./07-concurrency/01-concurrency/02-goroutines/02-wait-group (deeper WaitGroup patterns)")
	fmt.Println("\n---------------------------------------------------")
	fmt.Println("NEXT UP: GC.2 -> 07-concurrency/01-concurrency/02-goroutines/02-wait-group")
