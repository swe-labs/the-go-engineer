...
```bash
go run ./07-concurrency/01-concurrency/02-goroutines/07-downloader
```
...
Next: `SY.1` -> [`07-concurrency/01-concurrency/03-sync-primitives/01-mutex-and-rwmutex`](../../03-sync-primitives/01-mutex-and-rwmutex/README.md)
