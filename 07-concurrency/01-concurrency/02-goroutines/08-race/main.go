...
//
// RUN: go run ./07-concurrency/01-concurrency/02-goroutines/08-race
// ============================================================================
...
func main() {
	...
	fmt.Println("\n---------------------------------------------------")
	fmt.Println("NEXT UP: GC.9 -> 07-concurrency/01-concurrency/02-goroutines/09-select-deep-dive")
