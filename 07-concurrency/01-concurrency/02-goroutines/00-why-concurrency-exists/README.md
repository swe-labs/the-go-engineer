...
```bash
go run ./07-concurrency/01-concurrency/02-goroutines/00-why-concurrency-exists
```
...
Next: `GC.1` -> [`07-concurrency/01-concurrency/02-goroutines/01-goroutine`](../01-goroutine/README.md)
