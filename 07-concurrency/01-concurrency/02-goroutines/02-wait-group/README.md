...
```bash
go run ./07-concurrency/01-concurrency/02-goroutines/02-wait-group
```
...
Next: `GC.3` -> [`07-concurrency/01-concurrency/02-goroutines/03-channels`](../03-channels/README.md)
