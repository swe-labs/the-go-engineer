...
// ============================================================================
//
// RUN: go run ./07-concurrency/01-concurrency/03-sync-primitives/02-once-and-sync-map
// ============================================================================
...
func main() {
	...
	fmt.Println("\n---------------------------------------------------")
	fmt.Println("NEXT UP: SY.3 -> 07-concurrency/01-concurrency/03-sync-primitives/03-atomic-operations")
