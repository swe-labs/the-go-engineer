...
```bash
go run ./07-concurrency/01-concurrency/03-sync-primitives/06-deadlocks
```
...
Next: `CT.1` -> [`07-concurrency/01-concurrency/01-context/01-background`](../../01-context/01-background/README.md)
