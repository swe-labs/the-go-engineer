...
```bash
go run ./07-concurrency/01-concurrency/03-sync-primitives/03-atomic-operations
```
...
Next: `SY.4` -> [`07-concurrency/01-concurrency/03-sync-primitives/04-race-conditions`](../04-race-conditions/README.md)
