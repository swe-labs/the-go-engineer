...
```bash
go run ./07-concurrency/01-concurrency/03-sync-primitives/05-goroutine-leaks
```
...
Next: `SY.6` -> [`07-concurrency/01-concurrency/03-sync-primitives/06-deadlocks`](../06-deadlocks/README.md)
