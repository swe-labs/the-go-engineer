...
```bash
go run ./07-concurrency/01-concurrency/03-sync-primitives/01-mutex-and-rwmutex
```
...
Next: `SY.2` -> [`07-concurrency/01-concurrency/03-sync-primitives/02-once-and-sync-map`](../02-once-and-sync-map/README.md)
