...
//
// RUN:
//   go run ./07-concurrency/01-concurrency/01-context/01-background
//
// KEY TAKEAWAY:
//   - Background and TODO fundamentals and practical application in Go.
// ============================================================================
...
func main() {
	...
	fmt.Println()
	fmt.Println("   Next: go run ./07-concurrency/01-concurrency/01-context/02-with-cancel")
	fmt.Println("\n---------------------------------------------------")
	fmt.Println("NEXT UP: CT.2 -> 07-concurrency/01-concurrency/01-context/02-with-cancel")
