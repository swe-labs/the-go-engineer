...
//
// RUN:
//   go run ./07-concurrency/01-concurrency/01-context/02-with-cancel
//
// KEY TAKEAWAY:
...
func main() {
	...
	fmt.Println()
	fmt.Println("   Next: go run ./07-concurrency/01-concurrency/01-context/03-with-timeout")
	fmt.Println("\n---------------------------------------------------")
	fmt.Println("NEXT UP: CT.3 -> 07-concurrency/01-concurrency/01-context/03-with-timeout")
