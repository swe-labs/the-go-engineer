...
//
// RUN: go run ./08-quality-test/01-quality-and-performance/http-client-testing/3-manual-mock
// ============================================================================
...
func main() {
	...
	fmt.Println("\n---------------------------------------------------")
	fmt.Println("NEXT UP: HM.2 -> 08-quality-test/01-quality-and-performance/http-client-testing/4-manual-mock-2")
