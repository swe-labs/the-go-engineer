...
// RUN: go run ./08-quality-test/01-quality-and-performance/http-client-testing/6-testify-mock
package main
...
//
// RUN: go test -v ./08-quality-test/01-quality-and-performance/http-client-testing/6-testify-mock
// ============================================================================
