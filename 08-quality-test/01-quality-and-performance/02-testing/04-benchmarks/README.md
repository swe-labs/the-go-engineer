...
go test -bench=. -benchmem ./08-quality-test/01-quality-and-performance/02-testing/04-benchmarks
```
...
Next: `TE.5` -> [`08-quality-test/01-quality-and-performance/02-testing/05-sub-tests-and-cleanup`](../05-sub-tests-and-cleanup/README.md)
