...
//
// RUN:
//   go test ./08-quality-test/01-quality-and-performance/02-testing/01-unit-testing
// ============================================================================
...
//
// NEXT UP: TE.2 -> 08-quality-test/01-quality-and-performance/02-testing/02-table-driven-tests
func main() {
	fmt.Println()
	fmt.Println("---------------------------------------------------")
	fmt.Println("NEXT UP: TE.2 -> 08-quality-test/01-quality-and-performance/02-testing/02-table-driven-tests")
	fmt.Println("Run    : go test ./08-quality-test/01-quality-and-performance/02-testing/02-table-driven-tests")
