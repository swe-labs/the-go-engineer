...
go test -v ./08-quality-test/01-quality-and-performance/02-testing/09-integration-tests
```
...
Next: `TE.10` -> [`08-quality-test/01-quality-and-performance/02-testing/10-golden-files`](../10-golden-files/README.md)
