...
//
// NEXT UP: TE.4 -> 08-quality-test/01-quality-and-performance/02-testing/04-benchmarks
func main() {
	fmt.Println()
	fmt.Println("---------------------------------------------------")
	fmt.Println("NEXT UP: TE.4 -> 08-quality-test/01-quality-and-performance/02-testing/04-benchmarks")
	fmt.Println("Run    : go test -bench=. -benchmem ./08-quality-test/01-quality-and-performance/02-testing/04-benchmarks")
