...
go test ./08-quality-test/01-quality-and-performance/02-testing/06-fuzz-testing

# Run the actual fuzzer (will run until you stop it with Ctrl+C)
go test -fuzz=Fuzz ./08-quality-test/01-quality-and-performance/02-testing/06-fuzz-testing
```
...
Next: `TE.7` -> [`08-quality-test/01-quality-and-performance/02-testing/07-interfaces-for-testability`](../07-interfaces-for-testability/README.md)
