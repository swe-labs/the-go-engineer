...
go test -v ./08-quality-test/01-quality-and-performance/02-testing/05-sub-tests-and-cleanup
```
...
Next: `TE.6` -> [`08-quality-test/01-quality-and-performance/02-testing/06-fuzz-testing`](../06-fuzz-testing/README.md)
