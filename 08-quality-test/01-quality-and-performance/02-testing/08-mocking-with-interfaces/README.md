...
go test -v ./08-quality-test/01-quality-and-performance/02-testing/08-mocking-with-interfaces
```
...
Next: `TE.9` -> [`08-quality-test/01-quality-and-performance/02-testing/09-integration-tests`](../09-integration-tests/README.md)
