...
go test -v ./08-quality-test/01-quality-and-performance/02-testing/07-interfaces-for-testability
```
...
Next: `TE.8` -> [`08-quality-test/01-quality-and-performance/02-testing/08-mocking-with-interfaces`](../08-mocking-with-interfaces/README.md)
