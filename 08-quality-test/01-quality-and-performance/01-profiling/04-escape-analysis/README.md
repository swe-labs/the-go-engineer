...
go build -gcflags="-m" ./08-quality-test/01-quality-and-performance/01-profiling/04-escape-analysis
```
...
Next: `PR.5` -> [`08-quality-test/01-quality-and-performance/01-profiling/05-benchmark-driven-development`](../05-benchmark-driven-development/README.md)
