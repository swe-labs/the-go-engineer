...
//
// RUN:
//   go run ./08-quality-test/01-quality-and-performance/01-profiling/04-escape-analysis
//
// KEY TAKEAWAY:
//   - Learn how the compiler decides whether values stay on the stack or escape to the heap.
// ============================================================================
...
func main() {
	...
	fmt.Println()
	fmt.Println("---------------------------------------------------")
	fmt.Println("NEXT UP: PR.5 -> 08-quality-test/01-quality-and-performance/01-profiling/05-benchmark-driven-development")
