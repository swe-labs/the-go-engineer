...
go run ./08-quality-test/01-quality-and-performance/01-profiling/06-memory-layout
```
...
Next: `PD.1` -> [`09-architecture/01-package-design/01-naming`](../../../../09-architecture/01-package-design/01-naming/README.md)
