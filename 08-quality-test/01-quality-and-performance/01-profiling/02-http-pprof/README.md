...
```bash
# Run the demo server
go run ./08-quality-test/01-quality-and-performance/01-profiling/02-http-pprof
```
...
Next: `PR.3` -> [`08-quality-test/01-quality-and-performance/01-profiling/03-memory-profiling`](../03-memory-profiling/README.md)
