...
// RUN: go run ./08-quality-test/01-quality-and-performance/03-http-client-testing/4-manual-mock-2
package main
...
//
// RUN: go test -v ./08-quality-test/01-quality-and-performance/03-http-client-testing/4-manual-mock-2
// ============================================================================
...
func main() {
	...
	fmt.Println("\n---------------------------------------------------")
	fmt.Println("NEXT UP: HM.3 -> 08-quality-test/01-quality-and-performance/03-http-client-testing/5-manual-mock-table-driven")
