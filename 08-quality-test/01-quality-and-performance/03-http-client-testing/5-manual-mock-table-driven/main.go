...
// RUN: go run ./08-quality-test/01-quality-and-performance/03-http-client-testing/5-manual-mock-table-driven
package main
...
//
// RUN: go test -v ./08-quality-test/01-quality-and-performance/03-http-client-testing/5-manual-mock-table-driven
// ============================================================================
...
func main() {
	...
	fmt.Println("\n---------------------------------------------------")
	fmt.Println("NEXT UP: HM.4 -> 08-quality-test/01-quality-and-performance/03-http-client-testing/6-testify-mock")
