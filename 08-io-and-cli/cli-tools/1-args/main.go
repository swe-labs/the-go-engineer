...
// RUN: go run ./08-io-and-cli/cli-tools/1-args
package main
...
//
// RUN:
//   go run ./08-io-and-cli/cli-tools/1-args
//   go run ./08-io-and-cli/cli-tools/1-args hello world
//   GREETING=Hi go run ./08-io-and-cli/cli-tools/1-args gopher
// ============================================================================
...
func main() {
	...
	//
	// When you run: go run ./08-io-and-cli/cli-tools/1-args hello world
	...
	if len(os.Args) > 1 {
		...
		fmt.Println("  Try: go run ./08-io-and-cli/cli-tools/1-args hello world")
	}
	...
	fmt.Printf("  %s, %s!\n", greeting, user)
	fmt.Println("  Try: GREETING=Howdy go run ./08-io-and-cli/cli-tools/1-args")
	...
	fmt.Println()
	fmt.Println("   Next: go run ./08-io-and-cli/cli-tools/2-flags -name='The Go Engineer' -count=3")
	fmt.Println("\n---------------------------------------------------")
