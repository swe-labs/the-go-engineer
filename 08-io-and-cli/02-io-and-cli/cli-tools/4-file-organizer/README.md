...
```bash
go run ./08-io-and-cli/02-io-and-cli/cli-tools/4-file-organizer --dir=./my-folder
```

Run the starter:

```bash
go run ./08-io-and-cli/02-io-and-cli/cli-tools/4-file-organizer/_starter --dir=./my-folder
```
