...
// RUN: go run ./08-io-and-cli/02-io-and-cli/cli-tools/4-file-organizer
package main
...
//
// USAGE: go run ./08-io-and-cli/02-io-and-cli/cli-tools/4-file-organizer --dir=./my-messy-folder
