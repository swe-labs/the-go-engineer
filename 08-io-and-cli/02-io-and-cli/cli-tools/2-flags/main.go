...
// RUN: go run ./08-io-and-cli/02-io-and-cli/cli-tools/2-flags
package main
...
//
// RUN:
//   go run ./08-io-and-cli/02-io-and-cli/cli-tools/2-flags
//   go run ./08-io-and-cli/02-io-and-cli/cli-tools/2-flags -name="The Go Engineer" -count=3 -verbose
//   go run ./08-io-and-cli/02-io-and-cli/cli-tools/2-flags -help
// ============================================================================
