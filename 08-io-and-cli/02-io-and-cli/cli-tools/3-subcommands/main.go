...
// RUN: go run ./08-io-and-cli/02-io-and-cli/cli-tools/3-subcommands
package main
...
//
// RUN:
//   go run ./08-io-and-cli/02-io-and-cli/cli-tools/3-subcommands greet -name="Gopher"
//   go run ./08-io-and-cli/02-io-and-cli/cli-tools/3-subcommands version
//   go run ./08-io-and-cli/02-io-and-cli/cli-tools/3-subcommands calc -a=10 -b=20
// ============================================================================
