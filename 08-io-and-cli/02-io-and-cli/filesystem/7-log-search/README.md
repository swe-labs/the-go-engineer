...
```bash
go run ./08-io-and-cli/02-io-and-cli/filesystem/7-log-search
```

Run the tests:

```bash
go test ./08-io-and-cli/02-io-and-cli/filesystem/7-log-search
```

Run the starter:

```bash
go run ./08-io-and-cli/02-io-and-cli/filesystem/7-log-search/_starter
```
