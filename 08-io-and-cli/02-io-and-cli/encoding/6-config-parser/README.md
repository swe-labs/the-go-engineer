...
```bash
go run ./08-io-and-cli/02-io-and-cli/encoding/6-config-parser
```

Run the tests:

```bash
go test ./08-io-and-cli/02-io-and-cli/encoding/6-config-parser
```

Run the starter:

```bash
go run ./08-io-and-cli/02-io-and-cli/encoding/6-config-parser/_starter
```
