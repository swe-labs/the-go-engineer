...
const file_proto_order_proto_rawDesc = "" +
	...
	"\x12ProcessOrderStream\x12\x13.order.v1.OrderItem\x1a\x17.order.v1.ProcessResult(\x010\x01B1Z/github.com/rasel9t6/the-go-engineer/13-application-architecture/grpc/genb\x06proto3"
