...
// RUN: go run ./13-application-architecture/grpc/2-streaming/server
package main
...
import (
	...
	pb "github.com/rasel9t6/the-go-engineer/13-application-architecture/grpc/gen"
)
...
//
// RUN:
//   Terminal 1: go run ./13-application-architecture/grpc/2-streaming/server
//   Terminal 2: go run ./13-application-architecture/grpc/2-streaming/client
// ============================================================================
