...
```bash
go run ./11-concurrency-patterns/5-url-checker-exercise
```

Run the starter:

```bash
go run ./11-concurrency-patterns/5-url-checker-exercise/_starter
```
...
[Section 13: Quality and Performance](../../12-quality-and-performance).
