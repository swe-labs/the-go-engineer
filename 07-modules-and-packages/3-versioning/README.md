...
```bash
go run ./07-modules-and-packages/3-versioning
```

Run the tests:

```bash
go test ./07-modules-and-packages/3-versioning
```

Run the starter:

```bash
go run ./07-modules-and-packages/3-versioning/_starter
```
...
After you complete this exercise, continue to [Section 09](../../08-io-and-cli) if you are ready
to move on.
