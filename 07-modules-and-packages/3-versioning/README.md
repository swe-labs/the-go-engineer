...
```bash
go run ./07-modules-and-packages/01-modules-and-packages/3-versioning
```

Run the tests:

```bash
go test ./07-modules-and-packages/01-modules-and-packages/3-versioning
```

Run the starter:

```bash
go run ./07-modules-and-packages/01-modules-and-packages/3-versioning/_starter
```
...
After you complete this exercise, continue to [Stage 05](../../07-modules-and-packages/02-io-and-cli) if you are ready
to move on.
