...
// RUN: go run ./07-modules-and-packages/01-modules-and-packages/4-build-tags
// Try also: go test -v -tags=integration ./07-modules-and-packages/01-modules-and-packages/4-build-tags
package main
