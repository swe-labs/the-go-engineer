...
// RUN: go run ./07-modules-and-packages/1-module-basics
package main
...
func main() {
	...
	fmt.Println("  github.com/rasel9t6/the-go-engineer/09-web-and-database/databases/6-repository/models")
	fmt.Println("  github.com/rasel9t6/the-go-engineer/09-web-and-database/databases/6-repository/repository")
	fmt.Println()
