...
def main():
    p=argparse.ArgumentParser(); p.add_argument("--metadata-dir", default="metadata"); p.add_argument("--curriculum-dir", default="curriculum"); p.add_argument("--output", default="dist/labs-audit.json"); args=p.parse_args()
    ...
    report={"kind":"labs","count":len(records),"findings":findings}
