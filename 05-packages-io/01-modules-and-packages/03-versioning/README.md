...
```bash
go run ./05-packages-io/01-modules-and-packages/03-versioning
```
...
- Use `go run ./05-packages-io/01-modules-and-packages/03-versioning`.
- Starter path: `05-packages-io/01-modules-and-packages/03-versioning/_starter`.
...
> [!TIP]
> You now understand how versions are managed and enforced. But how do you handle different versions of your own code for different environments (e.g., Windows vs Linux)? In [Lesson 4: Build Tags](../04-build-tags/README.md), you will learn how to control which files are included in your binary.

## Next Step

Next: `MP.4` -> [`05-packages-io/01-modules-and-packages/04-build-tags`](../04-build-tags/README.md)
