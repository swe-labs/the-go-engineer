...
func main() {
	...
	fmt.Println("  github.com/swe-labs/the-go-engineer/06-backend-db/01-web-and-database/03-databases/06-repository/models")
	fmt.Println("  github.com/swe-labs/the-go-engineer/06-backend-db/01-web-and-database/03-databases/06-repository/repository")
	fmt.Println()
	...
	fmt.Println("\n---------------------------------------------------")
	fmt.Println("NEXT UP: MP.2 -> 05-packages-io/01-modules-and-packages/02-managing-deps")
