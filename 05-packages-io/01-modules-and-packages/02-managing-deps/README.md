...
> [!TIP]
> You can now manage external code. But how do you decide which version number to use? In [Lesson 3: Versioning](../03-versioning/README.md), you will learn about Semantic Versioning (SemVer) and Go's unique compatibility rules.

## Next Step

Next: `MP.3` -> [`05-packages-io/01-modules-and-packages/03-versioning`](../03-versioning/README.md)
