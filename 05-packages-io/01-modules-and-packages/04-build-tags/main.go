...
// Try also: go test -v -tags=integration ./05-packages-io/01-modules-and-packages/04-build-tags
package main
...
func main() {
	...
	fmt.Println("\n---------------------------------------------------")
	fmt.Println("NEXT UP: CL.1 -> 05-packages-io/02-io-and-cli/01-cli-tools/01-args")
