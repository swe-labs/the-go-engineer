...
| --- | --- | --- | --- |
| CLI Tools | [CL.1 args](./01-cli-tools) | `CL.4` | arguments, flags, subcommands, and a safe file-organizer CLI |
| Encoding | [EN.1 marshalling](./02-encoding) | `EN.6` | JSON encoding/decoding, streaming, base64, and config loading |
| Filesystem | [FS.1 files](./03-filesystem) | `FS.7` | file I/O, traversal, embed, I/O composition, and log search |
