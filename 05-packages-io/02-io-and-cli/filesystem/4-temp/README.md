...
> **Forward Reference:** You've learned how to handle files on the disk. But what if you want to include files _inside_ your compiled binary? In [Lesson 5: Embed](../5-embed/README.md), you will learn how to use Go's `embed` package to bundle assets directly into your application.
