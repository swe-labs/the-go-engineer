...
```bash
go run ./05-packages-io/02-io-and-cli/02-encoding/01-marshalling
```
...
> [!TIP]
> You have learned how to turn Go data into JSON. But what about the reverse? In [Lesson 2: Unmarshal](../02-unmarshal/README.md), you will learn how to take a JSON string and turn it back into a Go struct.

## Next Step

Next: `EN.2` -> [`05-packages-io/02-io-and-cli/02-encoding/02-unmarshal`](../02-unmarshal/README.md)
