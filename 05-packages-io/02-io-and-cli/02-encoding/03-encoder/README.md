...
> [!TIP]
> You have learned how to stream data OUT. Now we will look at the reverse: how to efficiently read a continuous stream of JSON data IN. In [Lesson 4: Decode](../04-decode/README.md), you will learn about the `json.Decoder`.

## Next Step

Next: `EN.4` -> [`05-packages-io/02-io-and-cli/02-encoding/04-decode`](../04-decode/README.md)
