...
| --- | --- | --- | --- | --- |
| `EN.1` | Lesson | [JSON marshalling](./01-marshalling) | Introduces struct-to-JSON serialization and struct tags. | entry |
...
then the encoding part of Stage 05 is doing its job.

## Next Step

After `EN.6`, continue to the [Filesystem track](../03-filesystem) or back to the
