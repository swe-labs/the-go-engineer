...
//   GREETING=Hi go run ./05-packages-io/02-io-and-cli/01-cli-tools/01-args gopher
...
func main() {
	...
	//
	// When you run: go run ./05-packages-io/02-io-and-cli/01-cli-tools/01-args hello world
	...
	if len(os.Args) > 1 {
		...
		fmt.Println("  Try: go run ./05-packages-io/02-io-and-cli/01-cli-tools/01-args hello world")
	}
	...
	fmt.Printf("  %s, %s!\n", greeting, user)
	fmt.Println("  Try: GREETING=Howdy go run ./05-packages-io/02-io-and-cli/01-cli-tools/01-args")
	...
	fmt.Println()
	fmt.Println("\n---------------------------------------------------")
	fmt.Println("NEXT UP: CL.2 -> 05-packages-io/02-io-and-cli/01-cli-tools/02-flags")
