...
//
//   go run ./05-packages-io/02-io-and-cli/01-cli-tools/03-subcommands greet -name="Gopher"
//   go run ./05-packages-io/02-io-and-cli/01-cli-tools/03-subcommands version
//   go run ./05-packages-io/02-io-and-cli/01-cli-tools/03-subcommands calc -a=10 -b=20
...
func main() {
	...
	fmt.Println("\n---------------------------------------------------")
	fmt.Println("NEXT UP: CL.4 -> 05-packages-io/02-io-and-cli/01-cli-tools/04-file-organizer")
