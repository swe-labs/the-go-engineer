...
//
//   go run ./05-packages-io/02-io-and-cli/01-cli-tools/02-flags
//   go run ./05-packages-io/02-io-and-cli/01-cli-tools/02-flags -name="The Go Engineer" -count=3 -verbose
...
func main() {
	...
	fmt.Println("\n---------------------------------------------------")
	fmt.Println("NEXT UP: CL.3 -> 05-packages-io/02-io-and-cli/01-cli-tools/03-subcommands")
