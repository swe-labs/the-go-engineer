...
//
// RUN:
//   go run ./05-packages-io/02-io-and-cli/03-filesystem/08-fs-testing-seam
//
// KEY TAKEAWAY:
...
To see the fs.FS testing seam in action, run:
  go test -v ./05-packages-io/02-io-and-cli/03-filesystem/08-fs-testing-seam
...
`)
	...
	fmt.Println("\n---------------------------------------------------")
	fmt.Println("NEXT UP: HS.1 -> 06-backend-db/01-web-and-database/05-http-servers/01-net-http-basics")
