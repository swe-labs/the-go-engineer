...
```bash
go run ./05-packages-io/02-io-and-cli/03-filesystem/03-dir
```
...
> [!TIP]
> You've learned how to manage permanent files and folders. But what about data that only needs to exist for a few minutes? In [Lesson 4: Temp Files](../04-temp/README.md), you will learn how to create and manage temporary files and directories that clean themselves up.

## Next Step

Next: `FS.4` -> [`05-packages-io/02-io-and-cli/03-filesystem/04-temp`](../04-temp/README.md)
