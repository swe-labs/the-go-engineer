...
```bash
go run ./05-packages-io/02-io-and-cli/03-filesystem/07-log-search
```
...
- Use `go run ./05-packages-io/02-io-and-cli/03-filesystem/07-log-search`.
- Starter path: `05-packages-io/02-io-and-cli/03-filesystem/07-log-search/_starter`.
...
> [!TIP]
> You've built a powerful tool that interacts with the real filesystem. But how do you test such a tool without actually creating and deleting files on your hard drive every time? In [Lesson 8: FS Testing Seam](../08-fs-testing-seam/README.md), you will learn how to use interfaces to create "Mock" filesystems for testing.

## Next Step

Next: `FS.8` -> [`05-packages-io/02-io-and-cli/03-filesystem/08-fs-testing-seam`](../08-fs-testing-seam/README.md)
