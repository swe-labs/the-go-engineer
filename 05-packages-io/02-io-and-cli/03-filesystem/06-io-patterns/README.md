...
```bash
go run ./05-packages-io/02-io-and-cli/03-filesystem/06-io-patterns
```
...
> [!TIP]
> You have mastered the building blocks of Go I/O. It's time to build a real-world tool that uses these patterns to solve a practical problem. In [Lesson 7: Log Search Project](../07-log-search/README.md), you will build a high-performance log searching tool using optimized I/O patterns.

## Next Step

Next: `FS.7` -> [`05-packages-io/02-io-and-cli/03-filesystem/07-log-search`](../07-log-search/README.md)
