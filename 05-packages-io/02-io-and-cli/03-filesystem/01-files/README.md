...
> [!TIP]
> You now know how to work with the contents of files. But how do you find those files and manage their names across different operating systems? In [Lesson 2: Paths](../02-paths/README.md), you will learn how to use the `path/filepath` package to handle file paths portably.

## Next Step

Next: `FS.2` -> [`05-packages-io/02-io-and-cli/03-filesystem/02-paths`](../02-paths/README.md)
