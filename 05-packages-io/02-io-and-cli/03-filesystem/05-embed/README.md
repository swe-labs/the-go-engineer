...
```bash
go run ./05-packages-io/02-io-and-cli/03-filesystem/05-embed
```
...
> [!TIP]
> You've learned the mechanics of files and directories. Now we will look at the higher-level design patterns used to move data between them. In [Lesson 6: IO Patterns](../06-io-patterns/README.md), you will learn about the powerful `io.Reader` and `io.Writer` interfaces.

## Next Step

Next: `FS.6` -> [`05-packages-io/02-io-and-cli/03-filesystem/06-io-patterns`](../06-io-patterns/README.md)
