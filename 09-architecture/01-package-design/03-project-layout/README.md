...
```bash
# Run the layout demo
go run ./09-architecture/01-package-design/03-project-layout
```
...
Next: `ARCH.1` -> [`09-architecture/03-architecture-patterns/01-architecture-trade-offs`](../../03-architecture-patterns/01-architecture-trade-offs/README.md)
