...
go run ./09-architecture/04-security/06-password-hashing
```
...
Next: `SEC.7` -> [`09-architecture/04-security/07-rate-limiting-patterns`](../07-rate-limiting-patterns/README.md)
