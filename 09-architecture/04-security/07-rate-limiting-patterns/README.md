...
go run ./09-architecture/04-security/07-rate-limiting-patterns
```
...
Next: `SEC.8` -> [`09-architecture/04-security/08-tls-and-https-in-go`](../08-tls-and-https-in-go/README.md)
