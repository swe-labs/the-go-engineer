...
go run ./09-architecture/04-security/04-authentication-basics
```
...
Next: `SEC.5` -> [`09-architecture/04-security/05-jwt-implementation-and-risks`](../05-jwt-implementation-and-risks/README.md)
