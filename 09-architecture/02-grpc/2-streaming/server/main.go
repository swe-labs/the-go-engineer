...
// RUN: go run ./09-architecture/02-grpc/2-streaming/server
package main
...
//
// RUN:
//   Terminal 1: go run ./09-architecture/02-grpc/2-streaming/server
//   Terminal 2: go run ./09-architecture/02-grpc/2-streaming/client
// ============================================================================
