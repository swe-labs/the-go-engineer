...
// RUN: go run ./09-architecture/02-grpc/02-streaming/client
package main
...
//
// RUN:
//   Terminal 1: go run ./09-architecture/02-grpc/02-streaming/server
//   Terminal 2: go run ./09-architecture/02-grpc/02-streaming/client
// ============================================================================
