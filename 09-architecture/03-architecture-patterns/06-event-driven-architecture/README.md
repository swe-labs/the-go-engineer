...
go run ./09-architecture/03-architecture-patterns/06-event-driven-architecture
```
...
Next: `ARCH.7` -> [`09-architecture/03-architecture-patterns/07-cqrs-basics`](../07-cqrs-basics/README.md)
