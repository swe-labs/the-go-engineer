...
go run ./09-architecture/03-architecture-patterns/05-service-layer-pattern
```
...
Next: `ARCH.6` -> [`09-architecture/03-architecture-patterns/06-event-driven-architecture`](../06-event-driven-architecture/README.md)
