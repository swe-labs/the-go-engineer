...
2. **The Ports**: The standardized sockets (USB-C, Bluetooth, Wi-Fi). These are interfaces that define _how_ to talk to the core.
...
- **Outbound Ports**: Interfaces that the Core _defines_ and _calls_.
