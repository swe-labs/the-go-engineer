...
go run ./09-architecture/03-architecture-patterns/02-ddd-basics
```
...
Next: `ARCH.3` -> [`09-architecture/03-architecture-patterns/03-hexagonal-architecture-in-go`](../03-hexagonal-architecture-in-go/README.md)
