...
go run ./09-architecture/03-architecture-patterns/07-cqrs-basics
```
...
Next: `ARCH.8` -> [`09-architecture/03-architecture-patterns/08-when-to-split-services`](../08-when-to-split-services/README.md)
