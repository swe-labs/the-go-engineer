...
go run ./09-architecture/03-architecture-patterns/04-repository-pattern-deep-dive
```
...
Next: `ARCH.5` -> [`09-architecture/03-architecture-patterns/05-service-layer-pattern`](../05-service-layer-pattern/README.md)
