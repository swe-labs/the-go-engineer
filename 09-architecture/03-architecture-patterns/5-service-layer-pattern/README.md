...
Sometimes, coordination needs to happen _after_ a task is finished. Learn how to decouple components even further. Continue to [ARCH.6 Event-driven architecture](../6-event-driven-architecture).
