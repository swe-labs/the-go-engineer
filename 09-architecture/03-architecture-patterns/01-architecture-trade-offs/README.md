...
go run ./09-architecture/03-architecture-patterns/01-architecture-trade-offs
```
...
Next: `ARCH.2` -> [`09-architecture/03-architecture-patterns/02-ddd-basics`](../02-ddd-basics/README.md)
