...
go run ./09-architecture/03-architecture-patterns/09-modular-refactor-exercise/_starter

# Run the tests to verify your refactored code
go test ./09-architecture/03-architecture-patterns/09-modular-refactor-exercise
```
...
- Use `go test ./09-architecture/03-architecture-patterns/09-modular-refactor-exercise/...`.
- Starter path: `09-architecture/03-architecture-patterns/09-modular-refactor-exercise/_starter`.
...
Next: `SEC.1` -> [`09-architecture/04-security/01-input-validation-patterns`](../../04-security/01-input-validation-patterns/README.md)
