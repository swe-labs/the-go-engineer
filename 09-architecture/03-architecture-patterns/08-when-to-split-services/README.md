...
go run ./09-architecture/03-architecture-patterns/08-when-to-split-services
```
...
Next: `ARCH.9` -> [`09-architecture/03-architecture-patterns/09-modular-refactor-exercise`](../09-modular-refactor-exercise/README.md)
