...
```bash
go run ./01-foundations/04-data-structures/6-contact-manager
```

Run the starter scaffold:

```bash
go run ./01-foundations/04-data-structures/6-contact-manager/_starter
```

Run the automated verification surface:

```bash
go test ./01-foundations/04-data-structures/6-contact-manager
```
...
1. `go run ./01-foundations/04-data-structures/6-contact-manager`
2. `go run ./01-foundations/04-data-structures/6-contact-manager/_starter`
3. `go test ./01-foundations/04-data-structures/6-contact-manager`
