...
// RUN: go run ./14-code-generation/3-sqlc
package main
...
// ============================================================================
// Section 15: Code Generation - sqlc Workflow
// Level: Core
// ============================================================================
//
// WHAT YOU'LL LEARN:
...
func main() {
	...
	fmt.Println("   Revisit any earlier capstone and apply code generation intentionally.")
	fmt.Println("---------------------------------------------------")
}
