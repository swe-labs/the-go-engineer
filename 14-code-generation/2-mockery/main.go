...
// RUN: go run ./14-code-generation/2-mockery
package main
...
import (
	...
	"github.com/rasel9t6/the-go-engineer/14-code-generation/2-mockery/internal/storage"
)
...
func main() {
	...
	fmt.Println("  go generate ./14-code-generation/2-mockery/...")
