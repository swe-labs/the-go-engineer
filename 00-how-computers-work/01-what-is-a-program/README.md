...
> [!NOTE]
> This fetch-decode-execute cycle is the foundation for understanding how the Go compiler translates source text into executable OpCodes in [HC.2 Code to Execution](../02-code-to-execution/README.md).
...
Next: `HC.2` -> [`00-how-computers-work/02-code-to-execution`](../02-code-to-execution/README.md)
